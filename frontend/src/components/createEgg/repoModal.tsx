...
const RepoModal = ({
      ...
      axios
        ...
        .then((res) => {
          ...
          axios
            .post(
              //moti생성 axios
              "http://k7a704.p.ssafy.io:8080/api/v1/moti",
              { motiName: nickname },
              {
                headers: {
                  Authorization: "Bearer " + window.sessionStorage.getItem("MotiToken"),
  ...
  return (
    <Modal>
      <Head>
        <img src="images/moti/onigiri.gif" alt="" />
        <span>밥그릇을 골라주세요</span>
        ...
        >
          <CloseRepoModalButtonImg src="images/shop/close.png" alt="" />
        </CloseRepoModalDiv>
      </Head>
      <Body>
        <RepoBody>
...
const CloseRepoModalDiv = styled.div`
  height: 100%;
...
const CloseRepoModalButtonImg = styled.img`
  width: 20px;
  height: 20px;
`
